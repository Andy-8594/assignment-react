...
// import MenuFormData from "../../../../types/forms/MenuFormData";
// import MenuModel from "../../../../types/models/MenuModel";
...
const Profile = () => {
    ...
    }, [user.length, isLoggedIn]);

    const getUserData = () => {
        axios.get("https://60dff0ba6b689e001788c858.mockapi.io/users/" + iduser)
        .then((response) => {
            console.log(response)
